...
class BookingControllerTest {
    ...
    void getBookingsByOwner_whenParamInvalid_thenReturnBsdRequest() throws Exception {
        ...
        verify(bookingService, never()).getBookingsByOwner(anyLong(), anyString(),any(OffsetPageRequest.class));
    }
     ...
     */
    @Test
    void getBookingsByBooker_whenParamInvalid_thenReturnBsdRequest() throws Exception {
        ErrorResponse error = new ErrorResponse("from: must be greater than or equal to 0. size: must be greater than or equal to 1.");
        ...
        assertEquals(error, actualError);
        verify(bookingService, never()).getBookingsByBookerId(anyLong(),anyString(),any(OffsetPageRequest.class));
    }
}
